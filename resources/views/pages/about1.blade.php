...
<body style="margin:auto; background-color:#000000;">
    <div class="main_bodymenu1" style="padding-bottom:278px;">
        ...
        <div class="onupper" id="onupper">
            ...
            <a href="{{ URL::to('about1') }}"style="color:#FF0000;">SOBRE NOSOTROS</a>
        ...
        <br><br>
        <a href="<?php echo $location; ?>"  style=" color:white; text-decoration:none; padding-bottom:5px;">INICIO</a><br>
        <a href="{{ URL::to('about1') }}" style="color:red; text-decoration:none;">SOBRE NOSOTROS</a><br>
...
<td colspan="2" height="183px;" align="center">
       <div id ="button1121" style="top:0px; margin-left:-105px; padding-right:30px; width:158px;"><button onClick="location.href = '{{ URL::to('menu1') }}';" style="width:148px;">VER EL MENÚ HOY</button></div>
                  <div id ="button1" style="top:-42px; margin-left:232px; width:133px; position:relative;"><button onClick="location.href = '{{ URL::to('contact1') }}';" style="width:148px; background-color:#00CC00;">PEDIR AHORA</button></div>
</td>
</tr>
</table></div>
</div>
...
<tr>
<td colspan="2" height="183px;" align="center"   >
       <div id ="button1121"  style="top:0px; margin-left:-105px; padding-right:30px;"><button onClick="location.href = '{{ URL::to('menu1') }}';" style="width:148px;">VER EL MENÚ HOY</button></div>
                  <div id ="button1" style="top:-42px; margin-left:232px; position:relative;"><button onClick="location.href = '{{ URL::to('contact1') }}';" style="width:148px; background-color:#00CC00;">PEDIR AHORA</button></div>
</td>
</tr>
</table></div>
</div>
...
<figure style="background-image:url(style/images/2.jpg)"></figure>
...
<div class="profile-dot">
<figure style="background-image:url(style/images/3.jpg);"></figure>
<figcaption>BM</figcaption>
</div>
<br>
<font color="#FF0000">Daiane Smith</font>,<font color="#FFFFFF">Cliente</font>
