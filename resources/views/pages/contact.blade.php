...
<body style="margin:auto; background-color:#000000;">
        ...
        <br>
            ...
            <div class="res1" id="res1" style="display:none; top:-157px; ">
                ...
                <a href="{{ URL::to('about') }}" style="color:#FFFFFF; text-decoration:none;">SOBRE NOSOTROS</a><br>
                 ...
                 <a href="{{ URL::to('contact') }}" style="color:red; text-decoration:none;">CONTACTO</a><br>
    ...
    <form action="{{route('pages.contactback')}}" method="post" >
    {{ csrf_field() }}
    <input type="text"  name="name1" placeholder="&nbsp;Name" id="name1" class="inx1" align="middle">
    <label style="color:  red;
    position: relative;
    
}">{{$errors->first('name1')}}</label>
    &emsp;&emsp;<input  type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" id="email1" name="email1" placeholder="&nbsp;E-mail" align="middle" class="inx1">
    <br><br>
    <label style="color:  red;
    position: relative;
    
}"><br>{{$errors->first('email1')}}</label>

                    
    <input type="text"  name="subject" placeholder="&nbsp;Subject" align="middle" class="inx2">
    <label style="color:  red;
    position: relative;
    
}">{{$errors->first('subject')}}</label>
    <br><br>
    <textarea class="inx3"  name="message"placeholder="&nbsp;Message" align="middle"></textarea>
    <label style="color: red;
    position: relative;
    ...
    <br><input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" id="email1" name="email1" placeholder="&nbsp;E-mail" align="middle" class="inx1" >
    <br>
    {{$errors->first('email1')}}</label>
    &emsp;&emsp;
    <label style="color:  red;
    position: relative;
