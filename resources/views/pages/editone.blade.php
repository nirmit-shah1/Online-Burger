...
<h1 class="h14">Update Details of The Burger</h1><br><br><br>
 ...
 <?php  
   $sql = "select * from menu where menu_id='".$id."'";
    ...
    <table class="insert1" align="center" style="border-color:#FFFFFF;" align="left" cellspacing="20px;">
            <form action="{{route('pages.updateback')}}" method="post" enctype='multipart/form-data'> 
                {{ csrf_field() }}
     <tr>
         <td><input type="number" name="id" value="<?php echo $id ?>" style="display:none;"></td></tr>
     </tr>

    <tr>    
    <td style="color:#FFFFFF;">Hamburger Name</td>
    <td ><input style="height:32px; width:283px;" value="<?php echo $row[1]; ?>" type="text" name="name1" required></td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;">Price</td>
    <td ><input style="height: 32px;width: 283px;" value="<?php echo $row[2]; ?>" type="number" name="price" required></td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;">Image</td>
    <td  style="width:164px;">
    <p class="pp1"><img src='<?php echo $image_src;  ?>' align="top" style="height:77px; width:77px;">
    </p>
    </td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;">Image Name</td>
    <td ><input style="height: 32px;width: 283px;" value="<?php echo $row[3]; ?>" type="text" name="imgname" required></td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;">Image</td>
    ...
    <td ><input style="height: 32px;width: 283px;" value="<?php echo $row[5]; ?>" type="number" name="calories" required></td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;">Description</td>
    <td ><input style="height: 32px;width: 283px;" type="text" name="description" value="<?php echo $row[6]; ?>" required></td>
    </tr>
    <tr>
    <td style="color:#FFFFFF;" colspan="2" align="center"><input type="submit" value="Edit The Burger" name="add" id="add" style="width:148px; top:-5px; background-color:#00CC00;color: white; height: 48px;"></div></td>
    </tr>
